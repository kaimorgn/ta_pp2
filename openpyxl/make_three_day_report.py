#!/usr/bin/env python3
#
# make_three_day_report.py
#
# [概要]
# 秋県大のキャリア情報センターが配布している
# インターンシップ実習報告書(1~3日間)を
# 自動編集して保存するプログラム．
# 
# なお，openpyxlを使った操作は
...
def make_three_day_report(save_dir, txt_path):
    '''
    [概要]
    1 ~ 3日分のインターンシップ実習報告書を作成する関数．
    '''
...
if __name__ == "__main__":
    ...
    make_three_day_report(save_dir, txt_path)
